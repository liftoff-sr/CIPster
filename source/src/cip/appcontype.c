...
ConnectionObject* GetExclusiveOwnerConnection( ConnectionObject* connection_object,
...
ConnectionObject* GetIoConnectionForConnectionData( ConnectionObject* connection_object,
        EipUint16* extended_error )
{
