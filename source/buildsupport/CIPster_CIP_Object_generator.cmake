FILE(GLOB_RECURSE FILES_FOUND "${CIPster_CIP_OBJECTS_DIR}/*CMakeLists.txt")

FOREACH(FILE ${FILES_FOUND})
  string(REPLACE "${CIPster_CIP_OBJECTS_DIR}" "" CIP_OBJECT_NAME ${FILE})
...
FOREACH(CIP_OBJECT ${CIP_OBJECT_LIST})
  ...
  SET(WRITE_FILE "${WRITE_FILE}ADD_SUBDIRECTORY(\"\${CIPster_CIP_OBJECTS_DIR}/${CIP_OBJECT}\")\n")
