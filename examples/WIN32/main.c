...
int main(int argc, char *arg[]) {
  ...
  if (argc != 12) {
    ...
    printf(
        "./CIPster ipaddress subnetmask gateway domainname hostaddress macaddress\n");
    printf(
        "    e.g. ./CIPster 192.168.0.2 255.255.255.0 192.168.0.1 test.com testdevice 00 15 C5 BF D0 87\n");
    exit(0);
  } else {
